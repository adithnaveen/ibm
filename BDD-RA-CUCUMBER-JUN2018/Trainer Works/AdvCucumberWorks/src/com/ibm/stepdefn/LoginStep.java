...
@Given("^the username and password is entered in mobile$")
public void the_username_and_password_is_entered_in_mobile() throws Throwable {

	System.out.println("%%%%%% the username and password is entered in mobile %%%%");

}

@Then("^take user to index page$")
public void take_user_to_index_page() throws Throwable {
	
	System.out.println("%%%% take user to index page  %%%% ");
